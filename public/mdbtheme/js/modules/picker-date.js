...
(function (factory) {
  ...
  DatePicker.defaults = (function (prefix) {
    ...
    return {
      ...
      labelMonthNext: 'ເດືອນຕໍ່ໄປ',
      labelMonthPrev: 'ເດືອນຜ່ານມາ',

      // The title label to use for the dropdown selectors
      labelMonthSelect: 'ເລືອກເດືອນ',
      labelYearSelect: 'ເລືອກປີ',

      // Months and weekdays
      monthsFull: ['ມັງກອນ', 'ກຸມພາ', 'ມີນາ', 'ເມສາ', 'ພຶດສະພາ', 'ມິຖຸນາ', 'ກໍລະກົດ', 'ສິງຫາ', 'ກັບຍາ', 'ຕຸລາ', 'ພະຈິກ', 'ທັນວາ'],
      monthsShort: ['ມັງກອນ', 'ກຸມພາ', 'ມີນາ', 'ເມສາ', 'ພຶດສະພາ', 'ມິຖຸນາ', 'ກໍລະກົດ', 'ສິງຫາ', 'ກັບຍາ', 'ຕຸລາ', 'ພະຈິກ', 'ທັນວາ'],
      weekdaysFull: ['ວັນທິດ', 'ວັນຈັນ', 'ວັນອັງຄານ', 'ວັນພຸດ', 'ວັນພະຫັດ', 'ວັນສຸຸກ', 'ວັນເສົາ'],
      weekdaysShort: ['ທິດ', 'ຈັນ', 'ຄານ', 'ພຸດ', 'ພຫ', 'ສຸກ', 'ເສົາ'],
